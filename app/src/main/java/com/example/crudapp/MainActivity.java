...
private FirebaseAuth auth;
    ...
    private void displayBottom(Course course)
    {
        ...
        View layout = from(this).inflate(R.layout.bottom_sheet_dialog,viexx);
        ...
        Button btn3=layout.findViewById(R.id.btn);
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                reference= data.getReference("panier").child(authh.getUid());
                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        reference.child(course.getCourse_ID()).setValue(course);
                        Toast.makeText(MainActivity.this, "Course Added to panier", Toast.LENGTH_SHORT).show();
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        ...
                        Toast.makeText(MainActivity.this, "Course Failed to add to panier"+error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
       ...
       switch (id)
       {
           ...
           case R.id.profil:
               ...
               in.putExtra("prof","Etudiant");
               startActivity(in);
               this.finish();

           case R.id.localisation:
               Intent innt= new Intent(MainActivity.this,local.class);
               startActivity(innt);
               this.finish();
           case R.id.panier:
               Intent p=new Intent(MainActivity.this,Panier.class);
               startActivity(p);
               this.finish();
